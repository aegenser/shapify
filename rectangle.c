...
int isInside(int x, int y, Rectangle *rectangle) {
  int translatedX = x - rectangle->centerX;
  int translatedY = y - rectangle->centerY;
  double rotatedX = translatedX * cos(-1.0 * degToRad(rectangle->angle)) \
                    - translatedY * sin(-1.0 * degToRad(rectangle->angle));
  double rotatedY = translatedY * cos(-1.0 * degToRad(rectangle->angle)) \
                    + translatedX * sin(-1.0 * degToRad(rectangle->angle));
...
void setMinMax(Rectangle *rectangle) {
  int verticesX[4];
  int verticesY[4];
  verticesX[0] = (int)(rectangle->width / 2.0 * cos(degToRad(rectangle->angle)) \
                    - rectangle->height / 2.0 * sin(degToRad(rectangle->angle)));
  verticesY[0] = (int)(rectangle->height / 2.0 * cos(degToRad(rectangle->angle)) \
                    + rectangle->width / 2.0 * sin(degToRad(rectangle->angle)));
  verticesX[1] = (int)(-1 * rectangle->width / 2.0 * cos(degToRad(rectangle->angle)) \
                    - rectangle->height / 2.0 * sin(degToRad(rectangle->angle)));
  verticesY[1] = (int)(rectangle->height / 2.0 * cos(degToRad(rectangle->angle)) \
                    - rectangle->width / 2.0 * sin(degToRad(rectangle->angle)));
  verticesX[2] = (int)(rectangle->width / 2.0 * cos(degToRad(rectangle->angle)) \
                    + rectangle->height / 2.0 * sin(degToRad(rectangle->angle)));
  verticesY[2] = (int)(-1 * rectangle->height / 2.0 * cos(degToRad(rectangle->angle)) \
                    + rectangle->width / 2.0 * sin(degToRad(rectangle->angle)));
  verticesX[3] = (int)(-1 * rectangle->width / 2.0 * cos(degToRad(rectangle->angle)) \
                    + rectangle->height / 2.0 * sin(degToRad(rectangle->angle)));
  verticesY[3] = (int)(-1 * rectangle->height / 2.0 * cos(degToRad(rectangle->angle)) \
                    - rectangle->width / 2.0 * sin(degToRad(rectangle->angle)));
...
void addRectangle(Image *canvas, Image *original, Error *error, int iter, double opacity) {
  ...
  rectangle.centerX = (int) (randomV() * (canvas->hor));
  rectangle.centerY = (int) (randomV() * (canvas->vert));
  rectangle.width = (int) (randomV() * 300);
  rectangle.height = (int) (randomV() * 300);
  rectangle.angle = (int) (randomV() * 180);
 ...
 //printf("%d\n", currentError);
  ...
  for(int k = 0; k < iter; k++) {
    ...
    while(!valid) {
      ...
      valid = 0;
      char whichMutation = (char)(14 * randomV());
      ...
      switch(whichMutation) {
        case 0:
          newRectangle.centerX = (int) (randomV() * extreme - halfExtreme + newRectangle.centerX);
          break;
        case 1:
          newRectangle.centerY = (int) (randomV() * extreme - halfExtreme + newRectangle.centerY);
          break;
        case 2:
          newRectangle.angle = (int) (randomV() * extreme - halfExtreme + newRectangle.angle) % 180;
          break;
        case 3:
          newRectangle.centerX = (int) (randomV() * extreme - halfExtreme + newRectangle.centerX);
          newRectangle.centerY = (int) (randomV() * extreme - halfExtreme + newRectangle.centerY);
          break;
        case 4:
          newRectangle.centerX = (int) (randomV() * (canvas->hor));
          newRectangle.centerY = (int) (randomV() * (canvas->vert));
          newRectangle.width = (int) (randomV() * 300);
          newRectangle.height = (int) (randomV() * 300);
          newRectangle.angle = (int) (randomV() * 180);
        case 5:
          newRectangle.width = (int) abs(randomV() * newRectangle.width);
          break;
        case 6:
          newRectangle.height = (int) abs(randomV() * newRectangle.height);
          break;
        case 7:
          newRectangle.width = (int) (randomV() * 300);
          newRectangle.height = (int) (randomV() * 300);
        ...
        case 9:
          ...
          break;
        case 10:
          newRectangle.width = (int) abs((randomV() + 1) * newRectangle.width);
          break;
        case 11:
          newRectangle.height = (int) abs((randomV() + 1) * newRectangle.height);
          break;
        case 12:
          newRectangle.width = (int) abs((randomV() + 1) * newRectangle.width);
          newRectangle.height = (int) abs((randomV() + 1) * newRectangle.height);
