...
int isInside(int x, int y, Ellipse *ellipse) {
  int translatedX = x - ellipse->centerX;
  int translatedY = y - ellipse->centerY;
  double rotatedX = translatedX * cos(-1.0 * degToRad(ellipse->angle)) \
                    - translatedY * sin(-1.0 * degToRad(ellipse->angle));
  double rotatedY = translatedY * cos(-1.0 * degToRad(ellipse->angle)) \
                    + translatedX * sin(-1.0 * degToRad(ellipse->angle));
...
void setMinMax(Ellipse *ellipse) {
  int verticesX[4];
  int verticesY[4];
  verticesX[0] = (int)(ellipse->width / 2.0 * cos(degToRad(ellipse->angle)) \
                    - ellipse->height / 2.0 * sin(degToRad(ellipse->angle)));
  verticesY[0] = (int)(ellipse->height / 2.0 * cos(degToRad(ellipse->angle)) \
                    + ellipse->width / 2.0 * sin(degToRad(ellipse->angle)));
  verticesX[1] = (int)(-1 * ellipse->width / 2.0 * cos(degToRad(ellipse->angle)) \
                    - ellipse->height / 2.0 * sin(degToRad(ellipse->angle)));
  verticesY[1] = (int)(ellipse->height / 2.0 * cos(degToRad(ellipse->angle)) \
                    - ellipse->width / 2.0 * sin(degToRad(ellipse->angle)));
  verticesX[2] = (int)(ellipse->width / 2.0 * cos(degToRad(ellipse->angle)) \
                    + ellipse->height / 2.0 * sin(degToRad(ellipse->angle)));
  verticesY[2] = (int)(-1 * ellipse->height / 2.0 * cos(degToRad(ellipse->angle)) \
                    + ellipse->width / 2.0 * sin(degToRad(ellipse->angle)));
  verticesX[3] = (int)(-1 * ellipse->width / 2.0 * cos(degToRad(ellipse->angle)) \
                    + ellipse->height / 2.0 * sin(degToRad(ellipse->angle)));
  verticesY[3] = (int)(-1 * ellipse->height / 2.0 * cos(degToRad(ellipse->angle)) \
                    - ellipse->width / 2.0 * sin(degToRad(ellipse->angle)));
...
void addEllipse(Image *canvas, Image *original, Error *error, int iter, double opacity) {
  ...
  ellipse.centerX = (int) (randomV() * (canvas->hor));
  ellipse.centerY = (int) (randomV() * (canvas->vert));
  ellipse.width = (int) (randomV() * 20);
  ellipse.height = (int) (randomV() * 20);
  ellipse.angle = (int) (randomV() * 180);
  ...
  for(int k = 0; k < iter; k++) {
    ...
    while(!valid) {
      ...
      switch(whichMutation) {
        case 0:
          newEllipse.centerX = (int) (randomV() * extreme - halfExtreme + newEllipse.centerX);
          break;
        case 1:
          newEllipse.centerY = (int) (randomV() * extreme - halfExtreme + newEllipse.centerY);
          break;
        case 2:
          newEllipse.angle = (int) (randomV() * extreme - halfExtreme + newEllipse.angle) % 180;
          break;
        case 3:
          newEllipse.centerX = (int) (randomV() * extreme - halfExtreme + newEllipse.centerX);
          newEllipse.centerY = (int) (randomV() * extreme - halfExtreme + newEllipse.centerY);
          break;
        case 4:
          newEllipse.centerX = (int) (randomV() * (canvas->hor));
          newEllipse.centerY = (int) (randomV() * (canvas->vert));
          newEllipse.width = (int) (randomV() * 300);
          newEllipse.height = (int) (randomV() * 300);
          newEllipse.angle = (int) (randomV() * 180);
        case 5:
          newEllipse.width = (int) abs(randomV() * newEllipse.width);
          break;
        case 6:
          newEllipse.height = (int) abs(randomV() * newEllipse.height);
          break;
        case 7:
          newEllipse.width = (int) (randomV() * 300);
          newEllipse.height = (int) (randomV() * 300);
        ...
        case 9:
          ...
          break;
        case 10:
          newEllipse.width = (int) abs((randomV() + 1) * newEllipse.width);
          break;
        case 11:
          newEllipse.height = (int) abs((randomV() + 1) * newEllipse.height);
          break;
        case 12:
          newEllipse.width = (int) abs((randomV() + 1) * newEllipse.width);
          newEllipse.height = (int) abs((randomV() + 1) * newEllipse.height);
